...
#region helpers (should probably be on its own file?)
...
function InitSession
{
    ...
    $config.LocalDebug = [String]::IsNullOrEmpty( (Read-Host "Do you wish to debug this solution locally? [Enter] for yes, type anything for no"))
}
